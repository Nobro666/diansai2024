...
{
    PID_Init(&bal.pos_pid, POSITION, 10.0f, 2.0f,  1.0f, 0.02f, 1.0f);
    PID_Init(&bal.ang_pid, POSITION, 30.0f, 5.0f,  3.0f, 0.05f, 1.5f);
...
void Balance_Control(void)
{
    ...
    if (bal.servo_pwm < 500)  bal.servo_pwm = 500;
    if (bal.servo_pwm > 2500) bal.servo_pwm = 2500;
