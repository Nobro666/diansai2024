...
void Trace_init(void)
{
    ...
    PID_Init(&tracking_pid, DELTA, 40.0f, 5.0f, 10, 0.0f, 0.0f);//kp再大一点？
    ...
    //电机PID参数初始化
    motor_l.PidInit(&motor_l, DELTA, 2000.0f, 1000.0f, 0.2, 0, 0);
    motor_r.PidInit(&motor_r, DELTA, 2000.0f, 1000.0f, 0.2, 0, 0);
}
